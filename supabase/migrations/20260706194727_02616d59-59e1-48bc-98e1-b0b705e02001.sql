...
BEGIN
  IF TG_OP = 'INSERT' THEN
    ...
    -- Datos personales: solo se exige el nombre del cliente.
    ...
    -- Datos financieros mínimos del crédito: obligatorios para que exista caso operativo.
    ...
    -- Numero de credito NO es obligatorio en simulación manual: se completa después en el expediente.
    ...
    -- Auditoria QA obligatoria para analistas / licenciados.
