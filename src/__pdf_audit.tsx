...
const props = {
  ...
  propuestasComerciales: [
    { index: 0, fuente: "automatica" as const, nuevaCuota: 2205365, nuevoPlazo: 192, incrementoMensual: 89149, añosEliminados: 2, cuotasEliminadas: 24, ahorroIntereses: 30000000, ahorroSeguros: 6943873, ahorroTotal: 36943873, honorarios: 2216632, totalProyectado: 420158872 },
    { index: 1, fuente: "automatica" as const, nuevaCuota: 2252115, nuevoPlazo: 180, incrementoMensual: 135899, añosEliminados: 3, cuotasEliminadas: 36, ahorroIntereses: 48000000, ahorroSeguros: 8628734, ahorroTotal: 56628734, honorarios: 3397724, totalProyectado: 400474011 },
    { index: 2, fuente: "automatica" as const, nuevaCuota: 2373189, nuevoPlazo: 156, incrementoMensual: 256973, añosEliminados: 5, cuotasEliminadas: 60, ahorroIntereses: 78000000, ahorroSeguros: 17063005, ahorroTotal: 95063005, honorarios: 5703780, totalProyectado: 362039740 },
    { index: 3, fuente: "automatica" as const, nuevaCuota: 2452276, nuevoPlazo: 144, incrementoMensual: 336060, añosEliminados: 6, cuotasEliminadas: 72, ahorroIntereses: 90000000, ahorroSeguros: 23788292, ahorroTotal: 113788292, honorarios: 5689415, totalProyectado: 343314453 },
  ],
};
