          ...
          <>
            <header className="border-b border-white/[0.06] px-7 py-6">
              <div className="flex items-center gap-3">
                <div
                  ...
                  style={{ background: "linear-gradient(135deg,#445DA3,#445DA3,#84B98F)" }}
                >
            ...
            <footer className="flex items-center justify-end gap-3 border-t border-white/[0.06] px-7 py-5">
              ...
              <button
                ...
                style={{
                  background: "linear-gradient(135deg,#445DA3,#445DA3,#84B98F)",
  ...
  return (
    <div className="flex flex-col items-center gap-4 px-8 py-10 text-center">
      <div
        ...
        style={{ background: "linear-gradient(135deg,#84B98F,#445DA3,#445DA3)" }}
      >
