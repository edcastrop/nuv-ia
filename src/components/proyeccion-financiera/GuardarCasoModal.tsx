            ...
            <header className="border-b border-white/[0.06] px-7 py-6">
              <div className="flex items-center gap-3">
                <div
                  ...
                  style={{ background: "linear-gradient(135deg, rgba(68,93,163,0.95), rgba(132,185,143,0.9))" }}
                >
  ...
  return (
    <div className="flex flex-col items-center gap-4 px-8 py-10 text-center">
      <div
        ...
        style={{ background: "linear-gradient(135deg, rgba(132,185,143,0.9), rgba(68,93,163,0.95))" }}
      >
