...
export const HOME_CONFIG: Partial<Record<AppRole, RoleHomeConfig>> = {
  ...
  licenciado: {
    ...
    quickActions: [
      ...
      { to: "/herramientas/simulador", label: "Simulador NUVEX", desc: "Explora sin crear caso", icon: LineChart, tone: "blue" },
      { to: "/herramientas/abonos", label: "Abonos a capital", desc: "Simula ahorro real", icon: PiggyBank, tone: "green" },
      { to: "/herramientas/amortizacion", label: "Amortización", desc: "Motor Pesos + UVR", icon: Calculator, tone: "blue" },
      { to: "/herramientas/capacidad-pago", label: "Capacidad de pago", desc: "Regla 30% / 40% VIS", icon: ShieldCheck, tone: "green" },
