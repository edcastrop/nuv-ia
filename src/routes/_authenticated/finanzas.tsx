  ...
  return (
    <div className="mx-auto max-w-[1400px] px-6 py-6">
      <div className="mb-5 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-semibold text-[#0A1226]">Finanzas y Tesorería</h1>
      ...
      <nav className="mb-6 flex flex-wrap gap-1.5 rounded-2xl border border-[#E3E7EE] bg-white p-1.5">
        {SUBMODULOS.map((s) => {
